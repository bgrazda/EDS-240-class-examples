...
ggplot(data = penguins, 
       mapping = aes(x = bill_length_mm, 
                     ...
                     colour = species)) +
  geom_point() +
  scale_color_manual(values = c('#59344F', '#8BBF9F', '#D6BA73'))
```
...
ggplot(data = penguins, 
       mapping = aes(x = bill_length_mm, 
                     ...
                     colour = body_mass_g)) +
  geom_point() +
  scale_color_gradient(low = '#D6F599', high = '#153B50')
```
...
# Bar plot useful for only summary statistics, geom_col does same
